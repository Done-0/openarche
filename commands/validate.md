...
2. Read the current validation artifact and keep its structure stable.
3. Use the validation artifact as the source of truth for:
   - acceptance checks
   - regression checks
   ...
   - blockers
   - readiness
4. If the user is attaching validation evidence, update the validation artifact instead of inventing a parallel format.
